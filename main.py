...
def draw_me_like_one_of_your_french_girls(image1, image2, image, imagename):
    iimagea = cv2.imread(image1)
    iimageb = cv2.imread(image2)

    new_image = np.concatenate((iimagea, iimageb), axis=0)

    for pair_calc in image.pairs[:100]:
    ...
    cv2.imwrite(imagename, new_image)
    cv2.waitKey(0)
...
image1.cohesion_pairs(500, 0.5)
draw_me_like_one_of_your_french_girls("DSC08551.png", "DSC08555.png", image1, "before.png")
image1.ransac("affine", 100, 100, 500, 100)
draw_me_like_one_of_your_french_girls("DSC08551.png", "DSC08555.png", image1, 'after.png')
